...
public class Solution {
    ...
    /**
     * `removeDiagonalChars` takes a 2D boolean
    ...
    /**
     * `remainingChars |= 1 << i;` is inside a
     ...
     * What's a bitmask?
     * 
     * In the context, remainingChars is a bitmask.
...
/*
 * This program finds the minimum number of operations required
